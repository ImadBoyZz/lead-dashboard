...
export const SECTOR_CATEGORIES: Record<string, string[]> = {
  // ── TIER 1: KERNFOCUS — actief prospecteren ──
  'installateurs': ['loodgieter', 'elektricien', 'HVAC verwarming', 'airco installatie', 'warmtepomp', 'zonnepanelen installateur', 'laadpaal installateur', 'ketelonderhoud', 'sanitair installateur'],
  'vastgoed': ['immokantoor makelaar', 'vastgoedbeheer', 'syndicus', 'vastgoedkantoor'],
  'medisch': ['tandarts', 'orthodontist', 'tandartspraktijk', 'tandheelkunde'],
  'dakwerken': ['dakwerker', 'dakgoot', 'zinkwerker', 'dakrenovatie', 'dakdekker'],
  'bouw': ['aannemer', 'renovatiebedrijf', 'schrijnwerker', 'vloerder tegelzetter', 'metselaar', 'bouwbedrijf'],
  // ── TIER 2: SECUNDAIR — opportunistisch ──
  'auto': ['garage autogarage', 'carwash', 'autohandel', 'bandencentrale', 'autoruiten', 'carrosserie'],
  'tuin': ['tuinaannemer', 'hovenier', 'boomverzorging', 'tuinaanleg', 'tuinarchitect'],
  'financieel': ['boekhouder', 'accountant', 'belastingadviseur', 'financieel adviseur', 'verzekeringskantoor'],
  'schilderwerk': ['schilder', 'behanger', 'decorateur', 'pleisterwerk', 'gevelrenovatie'],
  'ramen': ['ramen en deuren', 'schrijnwerkerij', 'rolluiken', 'zonwering', 'veranda'],
  'hout': ['timmerman', 'meubelmaker', 'parketvloer', 'houtbewerking'],
};

const SECTOR_LABELS: Record<string, string> = {
  // Tier 1: Kernfocus
  installateurs: 'Installateurs (HVAC/Elektro/Sanitair)',
  vastgoed: 'Vastgoed & Makelaars',
  medisch: 'Tandartsen & Orthodontie',
  dakwerken: 'Dakwerken',
  bouw: 'Bouw & Renovatie',
  // Tier 2: Secundair
  auto: 'Auto & Garage',
  tuin: 'Tuin & Groen',
  financieel: 'Accountants & Boekhouders',
  schilderwerk: 'Schilder & Decoratie',
  ramen: 'Ramen & Deuren',
  hout: 'Hout & Meubel',
};
...
const MOCK_LEADS: DiscoveredLead[] = [
  ...
  },
  {
    ...
    website: 'https://elektro-janssens.be',
    rating: 4.2,
    reviewCount: 42,
    businessStatus: 'OPERATIONAL',
    photosCount: 8,
